...
public class SocialLoginController {
    ...
    public ResponseEntity<AuthController.TokenRes> kakaoLogin(@RequestBody String accessToken) throws Exception {
        log.info("login accessT : {}", accessToken);
        LoginDTO loginDTO = socialLoginService.kakaoLogin(accessToken);
