...
public class AuthController {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<TokenRes> refresh(@CookieValue(value = "refreshToken") String refreshToken,
        ...
        try {
            ...
            if(userId == null) throw new JwtException("userId is null");
        ...
        // refresh 성공 시 refresh 갱신 (자동 로그인 구현 위함)
        String refresh = jwtProvider.generateRefreshToken(userId);
        refreshTokenService.save(userId, refresh);
    ...
    public ResponseEntity<ResponseDTO> sendFindIdCode(@RequestParam String email) throws Exception {
        ...
        String code = codeService.issueCode(VerifyCodeService.Purpose.FIND_ID, email, null);
    ...
    public ResponseEntity<ResponseDTO> findIdVerify(@RequestBody Map<String,String> body) {
        ...
        if (!codeService.verifyCode(VerifyCodeService.Purpose.FIND_ID, email, null, code))
    ...
    public ResponseEntity<ResponseDTO> sendResetPwCode(@RequestBody Map<String,String> body) throws Exception {
        ...
        String code = codeService.issueCode(VerifyCodeService.Purpose.FIND_ID, email, userId);
    ...
    public ResponseEntity<ResponseDTO> resetPwVerify(@RequestBody Map<String,String> body) throws Exception {
        ...
        if (!codeService.verifyCode(VerifyCodeService.Purpose.FIND_ID, email, userId, code))
            return ResponseEntity.ok(ResponseDTO
                    .builder()
                    .status(false)
                    .build());
